import java.util.*;
 ...
 public class CoffeMachine {
    ...
    private enum State {
        CHOOSING_ACTION,        // Вибір основної дії (buy, fill, take, remaining, exit)
        CHOOSING_COFFEE_TYPE,   // Вибір типу кави (1, 2, 3, back)
        FILLING_WATER,          // Запит кількості води
        FILLING_MILK,           // Запит кількості молока
        FILLING_BEANS,          // Запит кількості кавових зерен
        FILLING_CUPS,           // Запит кількості одноразових стаканчиків
        EXITING                 // Вихід з програми
    }

    private static class Coffee {
        final String name;
        final int water; // мл води
        final int milk;  // мл молока
        final int beans; // г кавових зерен
        final int cost;  // вартість (грн)
